...
internal let process_master_queue = DispatchQueue(label:"com.tannersilva.global.process", qos:maximumPriority, attributes:[.concurrent], target:Priority.highest.globalConcurrentQueue)
